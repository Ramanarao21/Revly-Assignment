...
const App = () => {
  ...
  return (
    <div className="bg-white flex flex-col gap-4 min-h-dvh min-w-[300px] p-4">
      <h1 className="text-black text-4xl font-semibold">InsightCheck</h1>
      ...
      <div className="self-center flex flex-col gap-5 w-[80%] mt-10">
        ...
        <button
          ...
          className="bg-green-400 self-center h-12 text-lg  rounded-lg text-Lime-500 font-normal cursor-pointer p-6 flex justify-center items-center"
        >
          Analyze
        </button>
      </div>
